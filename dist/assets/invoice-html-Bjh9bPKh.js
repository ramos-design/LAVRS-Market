...
@media screen {
    ...
    .pdf-export-bar { text-align: center; padding: 16px 0 24px; }
    .pdf-export-btn { display: inline-flex; align-items: center; gap: 8px; background: #D32F2F; color: #fff; border: none; padding: 12px 32px; font-size: 14px; font-weight: 700; cursor: pointer; letter-spacing: 0.5px; transition: background 0.2s; }
...
<div class="page">
    ...
    <div class="meta">
        ...
        <div class="meta-col">
            ...
            <div class="meta-row"><span class="meta-label">IBAN:</span><span class="meta-val sm">${e(B)}</span></div>
    ...
    <div class="parties">
        ...
        <div class="party">
            ...
            <div class="party-name">${e(E)}</div>
            ${j.map(t=>`<div class="party-line">${e(t)}</div>`).join("")}
    ...
    <div class="grand-total">
        Celkem k úhradě: <span>${n(I)} CZK</span>
    </div>
