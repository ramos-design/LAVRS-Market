const errorTranslations: Record<string, string> = {
  ...
  'New password should be different from the old password': 'Nové heslo se musí lišit od stávajícího hesla.',
  'User already registered': 'Účet s tímto e-mailem je již zaregistrovaný. Zkuste se přihlásit.',
  'Účet s tímto e-mailem je již zaregistrovaný. Zkuste se přihlásit.': 'Účet s tímto e-mailem je již zaregistrovaný. Zkuste se přihlásit.',
